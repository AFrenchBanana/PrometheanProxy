        ...
        while True:
            ...
            if isinstance(config[key][subkey], bool):
                ...
                if not new_value.isdigit():
                    ...
                    update = True
            elif subkey == "listenaddress" and not ipaddress.ip_address(new_value):
                print("Invalid value. Please enter a valid IP address")
            elif subkey == "port" and not new_value.isdigit() and int(new_value) < 0 and int(new_value) > 65535:
